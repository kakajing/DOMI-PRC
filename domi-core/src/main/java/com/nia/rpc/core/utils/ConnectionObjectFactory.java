...
public class ConnectionObjectFactory extends BasePooledObjectFactory<Channel> {
    ...
    private Channel createNewConChannel(){
        ...
        try {
            final ChannelFuture future = bootstrap.option(ChannelOption.CONNECT_TIMEOUT_MILLIS, 3000)
            ...
            channel.closeFuture().addListener(f -> LOGGER.info("Channel Close {} {}", ip, port));
            return channel;
